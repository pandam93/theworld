            ...
            <div class="row flex-nowrap justify-content-between align-items-center">
                <div class="col-4 pt-1">
                    <a class="navbar-brand" href="#">
                        <img src="{{ asset('img/bootstrap-solid.svg') }}" width="30" height="30"
    ...
    document.getElementById('logout-form').submit();">
            ...
            <nav class="nav d-flex justify-content-between">
                @foreach ($boards as $board)
                    <a class="p-2 text-muted"
                        href="{{ route('boards.show', [$board->short_name]) }}">{{ $board->name }}</a>
                @endforeach
            </nav>
        </div>
        ...
        <div class="jumbotron p-3 p-md-5 text-white rounded bg-dark">
            <div class="row">
                ...
                <div class="col-md-6 px-0">
                    <img class="img-fluid"
                        src="https://ca-times.brightspotcdn.com/dims4/default/d7d4d55/2147483647/strip/true/crop/750x422+0+0/resize/750x422!/quality/90/?url=https%3A%2F%2Fwww.trbimg.com%2Fimg-5436b8c6%2Fturbine%2Fzap-the-office-michaels-worst-moments-pics-012"
            ...
            <div class="col-md-6">
                <div class="card flex-md-row mb-4 box-shadow h-md-250">
                    ...
                    <img class="card-img-right flex-auto d-none d-md-block"
                        src="{{ asset('img/Eq0lomMXAAkd5Lz.jpeg') }}" width="200" height="250" alt="Card image cap">
                </div>
            </div>
            <div class="col-md-6">
                <div class="card flex-md-row mb-4 box-shadow h-md-250">
                    ...
                    <img class="card-img-right flex-auto d-none d-md-block"
                        src="{{ asset('img/Eq0hr_FW4AAIfyt.jpeg') }}" alt="Card image cap">
                </div>
            </div>
        </div>
